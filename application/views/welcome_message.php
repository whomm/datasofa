<html lang="en" class="app js no-touch no-android chrome no-firefox no-iemobile no-ie no-ie10 no-ie11 no-ios"><head>
<meta charset="utf-8">
<title>Datasofa</title>
<meta name="description" content="app, web app, responsive, admin dashboard, admin, flat, flat ui, ui kit, off screen nav">
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
<link rel="stylesheet" href="/noteadmin/css/app.v2.css" type="text/css">
<link rel="stylesheet" href="/noteadmin/js/calendar/bootstrap_calendar.css" type="text/css" cache="false">
<!--[if lt IE 9]> <script src="/noteadmin/js/ie/html5shiv.js" cache="false"></script> <script src="/noteadmin/js/ie/respond.min.js" cache="false"></script> <script src="/noteadmin/js/ie/excanvas.js" cache="false"></script> <![endif]-->
...
<section class="vbox">
  ...
  <section>
    <section class="hbox stretch"> <!-- .aside -->
      <aside class="bg-dark lter aside-md hidden-print" id="nav">
        <section class="vbox">
          ...
          <section class="w-f scrollable">
            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 0px;"><div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333" style="overflow: hidden; width: auto; height: 0px;"> <!-- nav -->
              <nav class="nav-primary hidden-xs">
                <ul class="nav">
                  <li class=""> <a href="#" class=""> <i class="fa fa-dashboard icon"> <b class="bg-danger"></b> </i> <span>Workset</span> </a> </li>
              ...
              <!-- / nav --> </div><div class="slimScrollBar" style="background: rgb(51, 51, 51); width: 5px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 0px; height: 860px;"></div><div class="slimScrollRail" style="width: 5px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 0px;"></div></div>
          </section>
      ...
      <!-- /.aside -->
      <section id="content">
      <iframe name="good" width="100%" height="100%">
      </iframe>
       </section>
...
<script src="/noteadmin/js/app.v2.js"></script> <!-- Bootstrap --> <!-- App --> <script src="/noteadmin/js/charts/easypiechart/jquery.easy-pie-chart.js" cache="false"></script> <script src="/noteadmin/js/charts/sparkline/jquery.sparkline.min.js" cache="false"></script> <script src="/noteadmin/js/charts/flot/jquery.flot.min.js" cache="false"></script> <script src="/noteadmin/js/charts/flot/jquery.flot.tooltip.min.js" cache="false"></script> <script src="/noteadmin/js/charts/flot/jquery.flot.resize.js" cache="false"></script> <script src="/noteadmin/js/charts/flot/jquery.flot.grow.js" cache="false"></script> <script src="/noteadmin/js/charts/flot/demo.js" cache="false"></script> <script src="/noteadmin/js/calendar/bootstrap_calendar.js" cache="false"></script> <script src="/noteadmin/js/calendar/demo.js" cache="false"></script> <script src="/noteadmin/js/sortable/jquery.sortable.js" cache="false"></script>
