...
#
# Host: 120.25.194.93 (MySQL 5.6.28-log)
# Database: datasofa
# Generation Time: 2016-11-12 12:36:09 +0000
# ************************************************************
...
INSERT INTO `actor` (`actor_id`, `fullname`, `last_update`)
VALUES
...
VALUES
	...
	(497,'sdfds','sdfd','sdf','23423','jghjgh','ghjghj','ghjhgj','ghjhgj','45454','ghjghj',1501,0),
	(498,'fh','fgh','fgh','234234','fgh','fh','fgh','dfg',NULL,'',NULL,NULL),
	(499,'sdfsdf','sdfdsf','3245','23234','',NULL,'',NULL,NULL,'',1401,NULL),
...
INSERT INTO `employees` (`employeeNumber`, `lastName`, `firstName`, `extension`, `email`, `officeCode`, `file_url`, `jobTitle`)
VALUES
	...
	(1703,'ming','w','goo','lacing@126.com','7','','sdfdsf');
...
INSERT INTO `film` (`film_id`, `title`, `description`, `release_year`, `rental_duration`, `rental_rate`, `length`, `replacement_cost`, `rating`, `special_features`, `last_update`)
VALUES
...
INSERT INTO `film_actor` (`actor_id`, `film_id`, `priority`)
VALUES
	(1,1,0),
	(1,23,0),
	(1,25,0),
...
# Dump of table spconf_book
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spconf_book`;
...
LOCK TABLES `spconf_book` WRITE;
/*!40000 ALTER TABLE `spconf_book` DISABLE KEYS */;

INSERT INTO `spconf_book` (`id`, `ip`, `bookinfourl`, `author`, `isgetsaleamount`, `booktype`, `themetype`, `pubtime`, `pubfrom`)
VALUES
	(1,'sdfsdf','','',0,2,2,'2016-11-10 00:00:00',''),
	(2,'dsfsdfds','http://sdfsdfsdfd','http://sdf',1,2,1,'2016-11-10 00:00:00','rerfgdg');

/*!40000 ALTER TABLE `spconf_book` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table spconf_book_theme
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spconf_book_theme`;

CREATE TABLE `spconf_book_theme` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='图书题材类型';

LOCK TABLES `spconf_book_theme` WRITE;
/*!40000 ALTER TABLE `spconf_book_theme` DISABLE KEYS */;

INSERT INTO `spconf_book_theme` (`id`, `name`)
VALUES
	(2,'考古'),
	(3,'测试'),
	(4,'sdfsdf');

/*!40000 ALTER TABLE `spconf_book_theme` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table spconf_book_type
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spconf_book_type`;

CREATE TABLE `spconf_book_type` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='图书体载类型';

LOCK TABLES `spconf_book_type` WRITE;
/*!40000 ALTER TABLE `spconf_book_type` DISABLE KEYS */;

INSERT INTO `spconf_book_type` (`id`, `name`)
VALUES
	(1,'实体'),
	(2,'网文');

/*!40000 ALTER TABLE `spconf_book_type` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table spconf_yesornot
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spconf_yesornot`;

CREATE TABLE `spconf_yesornot` (
  `id` int(11) unsigned NOT NULL,
  `yesorno` varchar(10) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `spconf_yesornot` WRITE;
/*!40000 ALTER TABLE `spconf_yesornot` DISABLE KEYS */;

INSERT INTO `spconf_yesornot` (`id`, `yesorno`)
VALUES
	(0,'否'),
	(1,'是');

/*!40000 ALTER TABLE `spconf_yesornot` ENABLE KEYS */;
UNLOCK TABLES;
