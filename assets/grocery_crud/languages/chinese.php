<?php
	...
	$lang['string_delete_file'] 	= "删除中...";
	$lang['string_progress'] 		= "进度: ";
	$lang['error_on_uploading'] 	= "上传文件出错.";
	$lang['message_prompt_delete_file'] 	= "确认删除?";

	$lang['error_max_number_of_files'] 	= "一次只能上传一个文件.";
	$lang['error_accept_file_types'] 	= "上传文件后缀不合法.";
	$lang['error_max_file_size'] 		= "上传文件大小超过 {max_file_size} 限制.";
	$lang['error_min_file_size'] 		= "不能上传空文件.";

	/* Added in version 1.3.1 */
	$lang['list_export'] 	= "导出";
	$lang['list_print'] 	= "打印";
	$lang['minimize_maximize'] = '最小/最大化';
